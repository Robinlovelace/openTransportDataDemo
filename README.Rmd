...
You can get national OD data from the Census into R with the following command:
...
Let's keep only OD data that have a start and end point in the study area:
...
The result is nearly 300 rows of data representing movement between origins and destinations.
...
# manual edit and debug
# file.edit("~/orgs/a-b-street/abstr/R/ab_scenario.R")
